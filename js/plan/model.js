...
export const DEFAULT_ANCHOR_MONDAY = '2026-08-17';
...
export const periodFactor = (period, actId) => {
...
export function dayCapacity(act, d, plan) {
  const r = act?.rhythm || {};
...
export const loggedOn = (act, plan, d) => (Array.isArray(plan?.log) ? plan.log : []).filter(e =>
...
export function planDeltaChip(finishDate, baselineDate, toleranceDays = 7) {
